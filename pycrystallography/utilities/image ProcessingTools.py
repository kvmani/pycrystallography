...
"""
Parameters:
img1: The first input image (PIL Image or NumPy array)
img2: The second input image (PIL Image or NumPy array)
Return Value:
unionMask: The unionMask variable is returned as the result of the function.
...
img2: The second input image (PIL Image or NumPy array)
Return Value:
addMaskresult: The result of adding pixel values of img1 and `img2 is returned as NUMPY array.
...
img2: The second input image (PIL Image or NumPy array)
Return Value:
subMaskresult: The result of subtracting pixel values of img2 from img1 is returned as NumPY array.
"""
...
"""
Parameters:
ang_file: The path to the input text file from which to extract NCOLS_ODD and NROWS.
Return Values:
nPoints: The result of multiplying NCOLS_ODD and NROWS. It represents the total number of points or elements.
NCOLS_ODD: The extracted integer value corresponding to the "NCOLS_ODD" found in the input file.
NROWS: The extracted integer value corresponding to the "NROWS" found in the input file.
            ...
            iaa.SomeOf((0, None), [
                ...
                sometimes(augmentationParameters["ContrastAndScaleGroupProb"],
                          iaa.SomeOf((0, None), [
                              ...
                              iaa.BlendAlphaCheckerboard(nb_rows=40, nb_cols=(50, 80),
                                                         foreground=iaa.AddToHue((-200, 200))),
