...
=======
    mask_image_path = os.path.join(settings["mask_paths"]["ebsd_masks"], f"18.png")
    # ebsd.applyMask(mask_image_path, displayImage=False)
    ebsd.applyMaskWithPercentage(mask_image_path, desired_percent=.94, tolerance=.05)
>>>>>>> 1dfd7168700669452f0afa02f28dfbe2775e62df
...
=======
            ...
            # "ebsd_masks": "/mnt/volume/EBSD_ML/EBSD_Mask/EBSD_mask_With Scratches/"
>>>>>>> 1dfd7168700669452f0afa02f28dfbe2775e62df
...
=======
    input_file = r"/home/kvmani/pycrystallography/data/sampleTestData/Project 1 AsBuilt_etched-BD Site 1 Map Data 12_crop0_rotation_270_flip_v_mask_34.ctf"
    logger = configure_logger(SETTINGS, input_file)
>>>>>>> 1dfd7168700669452f0afa02f28dfbe2775e62df
