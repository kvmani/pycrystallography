...
# Configuration
input_dir="/home/lus04/kvmani/ml_works/kaushal_2025/MMD_ctf_files_reduced/"
output_dir="/home/lus04/kvmani/ml_works/kaushal_2025/outputs/data4.0/"
log_file='/home/lus04/kvmani/ml_works/kaushal_2025/outputs/data4.0/progressLogs/progressLog.log'
...
xargs -P "$num_processors" -I {} bash -c '
  {
    ...
    active_processes=$(pgrep -fc "python3 process_ebsd_file.py")
    echo "$(date "+%Y-%m-%d %H:%M:%S") Active processors: $active_processes Processing: {}" >> "'"$log_file"'"

    # Run the Python script
    python3 process_ebsd_file.py --input_file "{}" --output_dir "'"$output_dir"'"
